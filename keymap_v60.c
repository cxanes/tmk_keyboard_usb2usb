...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |-----------------------------------------------------------|
     * |Caps |PgU|Up |PgD|   |   |   |PgU|Hom|PgD|PrS|ScL|Pau|Ins  |
     * |-----------------------------------------------------------|
    ...
    CAPS,PGUP,UP,  PGDN,TRNS,TRNS,TRNS,PGUP,HOME,PGDN,PSCR,SLCK,PAUS,     INS,      TRNS,TRNS,TRNS,    TRNS,TRNS,TRNS,TRNS,    TRNS,TRNS,
    TRNS,LEFT,DOWN,RGHT,HOME,INS, LEFT,DOWN,UP,  RGHT,BSPC,DEL,      TRNS,TRNS,                        TRNS,TRNS,TRNS,TRNS,    TRNS,TRNS,
    TRNS,TRNS,APP, TRNS,END, FN3, TRNS,END, HOME,PGUP,PGDN,END,      TRNS,UP,            PGUP,         TRNS,TRNS,TRNS,TRNS,    TRNS,TRNS,
    TRNS,TRNS,TRNS,TRNS,TRNS,     TRNS,     TRNS,TRNS,TRNS,TRNS,LEFT,DOWN,RGHT,     HOME,PGDN,END,     TRNS,     TRNS,TRNS,    TRNS,TRNS
    ),
